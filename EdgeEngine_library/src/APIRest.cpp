...
bool APIRest::POSTMeasurement(sample sam, string token)
{
  if (!TESTING)
  {
    ...
    httpCode = http.POST(("{\"thing\": \"" + sam.thing + "\", \"feature\": \"" + sam.feature + "\", \"device\": \"" + sam.device + "\", \"script\": \"" + sam.scriptId + "\", \"samples\": " + sam.sampleString.c_str() + ", \"startDate\": \"" + sam.startDate + "\", \"endDate\": \"" + sam.endDate + "\"}").c_str());// this is the body
    ...
    { // something has gone wrong in the POST
      ...
      if (needToBeRePOST(response))
      {
        ...
        Serial.print(", value: ");
        Serial.print((sam.sampleString).c_str());
        Serial.print(", script: ");
    ...
    {
      string postData = "{\"thing\": \"" + sam.thing + "\", \"feature\": \"" + sam.feature + "\", \"device\": \"" + sam.device + "\", \"script\": \"" + sam.scriptId + "\", \"samples\": {\"values\":" + (sam.sampleString.c_str()) + ", \"startDate\": \"" + sam.startDate + "\", \"endDate\": \"" + sam.endDate + "\"}";
      client.print("POST ");
